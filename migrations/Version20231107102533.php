 ...
 */
final class Version20231107102533 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE projects (id INT AUTO_INCREMENT NOT NULL, client VARCHAR(255) NOT NULL, production_period DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', work_link VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, proj_image VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, achievement VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
