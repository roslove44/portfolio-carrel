...
class ProjectsController extends AbstractController
{
    ...
    public function editProject(Request $request, Projects $project, PicturesServices $picturesService, SluggerInterface $slugger, EntityManagerInterface $em): Response
    {
        $form = $this->createForm(ProjectType::class, $project);
        $form->handleRequest($request);
